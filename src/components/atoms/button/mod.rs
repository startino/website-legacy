...
pub fn Button(props: &Props) -> Html {
    html! {
        <button type={props.btn_type.clone()} class="inline-flex overflow-hidden relative justify-center items-center py-3 px-6 font-bold text-on-ter rounded-md shadow-2xl group">
