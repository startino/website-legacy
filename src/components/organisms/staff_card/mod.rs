...
pub fn StaffCard(props: &Props) -> Html {
    ...
    html! {
            <a id="staffcard" href="#" class="flex flex-col items-center bg-secondary-dark rounded-lg border shadow-md md:flex-row dark:border-primary-800 dark:bg-primary-800/20 dark:hover:bg-primary-800/30 hover:bg-primary-100">
