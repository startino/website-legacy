...
#[function_component]
pub fn LargeStaffCard(props: &Props) -> Html {
    let Props { body, name, title } = props;

    html! {
        <div id="staff" class="py-6 px-4 sm:px-6 md:px-8 dark: border-secondary-600/40">
                <a href="#" class="flex flex-col items-center bg-white border rounded-lg shadow-md md:flex-row md:max-w-xl hover:bg-primary-100 dark:border-primary-800 dark:bg-primary-700 dark:hover:bg-primary-800">
