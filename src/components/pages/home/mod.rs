...
fn create(_ctx: &Context<Self>) -> Self {
    ...
    fn view(&self, _ctx: &Context<Self>) -> Html {
        ...
        <main>
            ...
            <div class="justify-items-center my-10 border-b border-pink-500/40 shadow-2xl">
                ...
                <div class="mx-auto max-w-6xl">
                    <Label>
                        ...
                        <h3 class="pt-3 p-5 ">
                            <a href="/about" class="text-purple-400 hover:text-emerald-400">{"Learn more about us."}</a>
                        </h3>
                    </Label>
                </div>
            </div>
